define(["./module"], function (module) {
    "use strict";
    module.directive("dgoNeueDriveby", ["$urlService", "$constantsService", "$filter", "$restService", "$newsService",
        function ($urlService, $constantsService, $filter, $restService, $newsService) {
            return {
                restrict: "E",
                replace: true,
                scope: true,
                templateUrl: "templates/dgo-neue-driveby.html",
                controller: function ($scope, $attrs) {
                    ...
                    $scope.classNamesDeatails = ["driveby-detail", "col-sm-4", "column-35", "col-sm-offset-4", "top-1", "panel panel-default"];
